...
<div class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3 stake-container">
                    <center><h3 style="color:#ffb84d;">Search user</h3></center>
        
                        <form action="#" method="GET"> 
                              <input class="form-control" type="text" name="criteria" placeholder="Search"/>
                                <input class="form-control" type="submit" name="submit_search" value="Search"><br/>
          ...
          if(!empty($criteria)){
          Profil::AdminSearchMember(10,$criteria);
          }else{
          echo "<center><p style='color:red;'>Enter search criteria!</p></center>";
          }
        }
        ?>
                </div>
                 ...
                 <div class="row">
                <div class="col-md-12 table-container">
                             <center><h3 style="color:#ffb84d;">Users - You can edit all users</h3></center>
                                    
                          <?=Admin::GetUsersAdmin(20)?>
